...
class Despachante {
    public:
        ...
        void executar(){
            ...
            while(proximo_a_ser_criado < (int)todos_os_processos.size() || !filas.todas_as_filas_estao_vazias()){

                admitir_processos(tempo_atual);
    ...
    private:
        ...
        void admitir_processos(int tempo_atual){
            while (proximo_a_ser_criado < (int)todos_os_processos.size() && todos_os_processos[proximo_a_ser_criado].tempo_chegada <= tempo_atual){
                filas.adicionar_processos_na_fila(todos_os_processos[proximo_a_ser_criado]);
                proximo_a_ser_criado++;
            }
        }
